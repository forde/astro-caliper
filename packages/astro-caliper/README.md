...
Astro Developer Toolbar App designed to assist frontend developers in converting designs to code. It provides visual aids and inspection tools directly within the browser.
...
- **Outlines**: Adds a subtle red outline to *all* elements to help see layout structure.
- **Highlight**: Provides a stronger outline for the currently inspected element.

## Installation & Integration

This app is integrated into the Astro project via the `dev-tools-integration.ts` file.

To use it in your Astro config:

```typescript
import devToolsIntegration from './apps/website/dev-tools/dev-tools-integration';
